...
def test_hrms ():
    with sync_playwright() as playwright:
        ...
        context = browser.new_context(record_video_dir="videos/hrms-20260626",record_video_size={"width":1280,"height":720})
        ...
        try:
            ...
            # expect(page.get_by_text("Welcome back, Nanda")).to_be_visible()
            ...
            expect(page).to_have_url("hello.com")

        except Exception as e:
            print(f"the expected url of the page is {e}")
        finally:
